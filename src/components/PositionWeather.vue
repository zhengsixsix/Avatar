<template>
  <div class="pos-wea-box">
    <img src="../assets/position/positionIcon.svg" class="position-img" />
...
async function getPosition(): Promise<void> {
  const posRes = await getNowPosition();
  try {
    const {
      ip,
      ad_info: { province, city },
      location: { lng, lat },
    } = posRes.result as Location;
    userIP.value = ip;
    userProvince.value = province;
    userCity.value = city;
    userLng.value = lng;
    userLat.value = lat;
    const weaRes = await getWeather(userLng.value, userLat.value);
    nowWeather.value = weaRes.code === "200" ? weaRes.now.text : "小雪";
    const weatherIcons = {
      晴: WeatherIcon.Sunny,
      多云: WeatherIcon.Cloudy,
      少云: WeatherIcon.Cloudy,
      晴间多云: WeatherIcon.Cloudy,
      阴: WeatherIcon.Cloudy,
      阵雨: WeatherIcon.Stormy,
      强阵雨: WeatherIcon.Stormy,
      雷阵雨: WeatherIcon.Stormy,
      强雷阵雨: WeatherIcon.Stormy,
      雷阵雨伴有冰雹: WeatherIcon.Stormy,
      小雨: WeatherIcon.Stormy,
      中雨: WeatherIcon.Stormy,
      大雨: WeatherIcon.Stormy,
      极端阵雨: WeatherIcon.Stormy,
      "毛毛雨/细雨": WeatherIcon.Stormy,
      暴雨: WeatherIcon.Stormy,
      大暴雨: WeatherIcon.Stormy,
      特大暴雨: WeatherIcon.Stormy,
      冻雨: WeatherIcon.Stormy,
      小到中雨: WeatherIcon.Stormy,
      中到大雨: WeatherIcon.Stormy,
      大到暴雨: WeatherIcon.Stormy,
      暴雨到大暴雨: WeatherIcon.Stormy,
      大暴雨到特大暴雨: WeatherIcon.Stormy,
      雨: WeatherIcon.Stormy,
      小雪: WeatherIcon.Snowy,
      中雪: WeatherIcon.Snowy,
      大雪: WeatherIcon.Snowy,
      暴雪: WeatherIcon.Snowy,
      雨夹雪: WeatherIcon.Snowy,
      雨雪天气: WeatherIcon.Snowy,
      阵雨夹雪: WeatherIcon.Snowy,
      阵雪: WeatherIcon.Snowy,
      小到中雪: WeatherIcon.Snowy,
      中到大雪: WeatherIcon.Snowy,
      大到暴雪: WeatherIcon.Snowy,
      雪: WeatherIcon.Snowy,
    };
    weatherIcon.value = weatherIcons[nowWeather.value] || WeatherIcon.Sunny;
  } catch (error) {
